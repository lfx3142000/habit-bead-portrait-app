...
* [x] Tune smooth two-axis table scrolling after phone testing
* [x] Verify Room persistence after close/reopen
* [x] Verify selected theme and bead-number preference persist after close/reopen
* [x] Verify decrement-to-zero persists as empty after close/reopen
